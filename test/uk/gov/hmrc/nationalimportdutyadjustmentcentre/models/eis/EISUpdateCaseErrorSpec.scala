...
class EISUpdateCaseErrorSpec extends UnitSpec with TestData {

  "EISUpdateCaseError" when {
    "fromStatusAndMessage" should {
      "return a valid ErrorCase and details" in {
        val error = EISUpdateCaseError.fromStatusAndMessage(101, "This would be the message")
